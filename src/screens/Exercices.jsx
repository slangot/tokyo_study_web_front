  ...
  return (
    <div className="mx-2">
      ...
      <div className="flex flex-col">
        ...
        {/* Levels */}
        <h2 className="mb-2 text-center">Choix du niveau :</h2>
        ...
        <div className="flex flex-col mt-5">
          ...
          {/* Méli-Mélo */}
          <a className="exerciceButton" href={`/exercices/melimelo`}>Méli-mélo</a>

          {/* Flashcard */}
          <div className="exerciceButton" onClick={() => handleOpenButton('flashcard')}>
            <h2>Flashcard</h2>
            {(openButton.type === 'flashcard' && openButton.status && level !== 0) && <div className="flex flex-row w-full mt-3 justify-evenly">
          ...
          {/* Drawing */}
          <a className="exerciceButton" href={`/exercices/drawing`}>Dessin</a>
